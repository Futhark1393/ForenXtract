# Author: Futhark1393
# Description: Report engine for Remote Forensic Imager.
...
class ReportEngine:
    ...
    def generate_reports(report_data: dict) -> None:
        ...
        - safe_mode, triage_requested, write_blocker
...
Write-Blocker    : {"ENABLED" if d.get("write_blocker") else "DISABLED"}
...
"""
    ...
    def _generate_pdf(d: dict, summary: str, filepath: str) -> None:
        ...
        with warnings.catch_warnings():
            ...
            row("Write-Blocker:", "ENABLED" if d.get("write_blocker") else "DISABLED")
