...
class ReportEngine:
    @staticmethod
    def _executive_summary(remote_sha256: str, hash_match, audit_hash: str, kernel_seal_success: bool) -> str:
        """
        ...
        if remote_sha256 == "SKIPPED" or remote_sha256 is None:
            return (
                ...
                f"The audit trail was sealed (Audit SHA-256: {audit_hash}). Kernel seal: {seal_str}."
            )
        ...
        if hash_match is True:
            return (
                ...
                f"Audit SHA-256: {audit_hash}. Kernel seal: {seal_str}."
            )
    ...
    def _generate_txt(d: dict, summary: str, filepath: str) -> None:
        ...
        safe_mode_status = "PADDED" if d.get("safe_mode") else "NOT USED"
...
3. PRE-ACQUISITION TRIAGE
--------------------------
Live Triage Log  : {triage_status}
Physical Handling: {safe_mode_status}
...
"""
    ...
    def _generate_pdf(d: dict, summary: str, filepath: str) -> None:
        ...
        pdf.ln(4)
        pdf.set_font("helvetica", "B", 12)
        pdf.cell(0, 10, "3. PRE-ACQUISITION TRIAGE", ln=1)
        pdf.set_font("helvetica", "", 11)
        row("Live Triage Log:", triage_status)
        row("Physical Handling:", safe_mode_status)
